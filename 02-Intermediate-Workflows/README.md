...
- [1. Theoretical Explanation](#1-theoretical-explanation)
  ...
  - [HEAD: Where You Are — Deep Dive](#head-where-you-are-right-now)
  - [Detached HEAD State](#head-where-you-are-right-now)
  - [git switch vs git checkout — Why Two Commands?](#git-switch-modern-vs-git-checkout-legacy)
  - [Fast-Forward Merge](#fast-forward-merge)
  - [3-Way (Recursive) Merge](#3-way-recursive-merge)
  - [Squash Merge](#squash-merge)
  - [Stash — Your Uncommitted Work Clipboard](#stash-your-uncommitted-work-clipboard)
- [2. Visual Diagrams (3 gitGraphs)](#2-visual-diagrams)
...
- [5. Practice Exercises](#5-️-practice-exercises)
  - [Exercise 1 — Branch Isolation Proof](#exercise-1--branch-isolation-proof)
  - [Exercise 2 — Force a Fast-Forward Merge](#exercise-2--force-a-fast-forward-merge)
  - [Exercise 3 — Force a 3-Way Merge](#exercise-3--force-a-3-way-merge-create-a-conflicts-friend)
  - [Exercise 4 — Create and Resolve a Merge Conflict](#exercise-4--create-and-resolve-a-merge-conflict)
  - [Exercise 5 — The Stash Rescue](#exercise-5--the-stash-rescue)
  - [Exercise 6 — List and Manage Multiple Stashes](#exercise-6--list-and-manage-multiple-stashes)
  - [Self-Assessment](#-module-02-self-assessment)
