...
- [1. Theoretical Explanation](#1-theoretical-explanation)
  ...
  - [Interactive Rebase (-i) — Squash, Fixup, Reorder, Drop](#interactive-rebase--i)
  - [Cherry-Pick — Copying a Single Commit](#cherry-pick-copying-a-commit)
  - [Reflog — Git's Undo History (Your Safety Net)](#reflog-gits-undo-history)
  - [git reset — All Three Modes (--soft, --mixed, --hard)](#git-reset--three-modes-explained-in-plain-english)
  - [git checkout vs git restore vs git reset — The Confusion Solved](#git-checkout-vs-git-restore-vs-git-reset--the-confusion-solved)
  - [git commit --amend](#git-commit---amend)
  - [git restore — Discarding Changes](#git-restore-file)
  - [git clean — Deleting Untracked Files](#git-clean--deleting-untracked-files)
- [2. Visual Diagrams (2 gitGraphs)](#2-visual-diagrams)
...
- [5. Practice Exercises](#5-️-practice-exercises)
  - [Exercise 1 — Fix a Bad Commit Message (Amend)](#exercise-1--fix-a-bad-commit-message-amend)
  - [Exercise 2 — Add a Forgotten File to Last Commit](#exercise-2--add-a-forgotten-file-to-last-commit)
  - [Exercise 3 — Squash Messy WIP Commits](#exercise-3--squash-messy-wip-commits-into-one-clean-commit)
  - [Exercise 4 — Rebase a Branch onto Main](#exercise-4--rebase-a-branch-onto-main-linear-history)
  - [Exercise 5 — Cherry-Pick a Specific Commit](#exercise-5--cherry-pick-a-specific-commit)
  - [Exercise 6 — The Full Reflog Recovery Drill](#exercise-6--the-full-reflog-recovery-drill)
  - [Exercise 7 — Discard Changes Surgically with git restore](#exercise-7--discard-changes-surgically-with-git-restore)
  - [Self-Assessment](#-module-04-self-assessment)
