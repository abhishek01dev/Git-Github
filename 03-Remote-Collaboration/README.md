...
- [1. Theoretical Explanation](#1-theoretical-explanation)
  ...
  - [git push — What Exactly Happens?](#git-push--what-exactly-happens)
  - [HTTPS vs SSH — Two Ways to Authenticate](#https-vs-ssh--two-ways-to-authenticate-with-github)
  - [Managing Your Remotes](#managing-your-remotes)
  - [git fetch vs git pull — With Analogy](#git-fetch-vs-git-pull)
  - [git pull --rebase vs git pull](#git-pull---rebase-vs-git-pull)
  - [Tracking Branches](#tracking-branches)
  - [Force Push: --force vs --force-with-lease](#force-push---force-vs---force-with-lease)
...
- [5. Practice Exercises](#5-️-practice-exercises)
  - [Exercise 1 — Verify Your Remote Setup](#exercise-1--verify-your-remote-setup)
  - [Exercise 2 — Push ONLY a Feature Branch](#exercise-2--push-only-a-feature-branch-not-main)
  - [Exercise 3 — Fetch vs Pull: Feel the Difference](#exercise-3--fetch-vs-pull-feel-the-difference)
  - [Exercise 4 — Simulate a Rejected Push and Fix It](#exercise-4--simulate-a-rejected-push-and-fix-it)
  - [Exercise 5 — Full Pull Request Cycle](#exercise-5--full-pull-request-cycle)
  - [Exercise 6 — Track a Remote Branch](#exercise-6--track-a-remote-branch-that-already-exists)
  - [Self-Assessment](#-module-03-self-assessment)
